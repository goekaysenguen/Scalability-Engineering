locals {
  ...
  # Cluster-Size = 1: API and worker run on Node 0
  # Cluster-Size > 1: APIs and workers runn ONLY on Node 1 to N (Node 0 only for Loadbalancer/Redis)
  ...
  # The DB scales over all Nodes... also Node 0
